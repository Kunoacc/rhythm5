            ...
            <div class="row">
                <div class="col-md-offset-1 col-sm-10 col-md-8">
                    <div class="card">
                        ...
                        <div class="content ">
                            <form action="{{route('createEvent')}}" method="post" role="form" enctype="multipart/form-data" id="newEventForm">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-sm-12">
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($events as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <button type="submit" class="btn btn-danger btn-fill" id="delete" onclick="deleteEvent('{{$item->id}}')"><i class="pe-7s-trash"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
