...
<body class="page body_style_wide body_filled article_style_stretch scheme_original top_panel_show top_panel_over sidebar_hide <?php echo $__env->yieldContent('body-class'); ?>">
