...
<?php $__env->startSection('title', 'Devotional'); ?>
               ...
               <div class="col-md-offset-1 col-sm-10 col-md-8">
                   <div class="card">
                       ...
                       <div class="content">
                           ...
                           <?php if(\App\Devotional::all()->isNotEmpty()): ?>
                               <table class="table table-hover">
                                   ...
                                   <tbody>
                                   <?php $__currentLoopData = $devotional; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <tr>
                                           <td><?php echo e($item->title); ?></td>
                                           <td><?php echo e($item->author); ?></td>
                                           <td><?php echo e($item->date); ?></td>
                                           <td>
                                               <button type="submit" class="btn btn-danger btn-fill" id="delete" onclick="deleteDay('<?php echo e($item->id); ?>')"><i class="pe-7s-trash"></i></button>
                                           </td>
                                       </tr>
...
<script>
    ...
    function deleteDay(id) {
        ...
        swal({
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo e(route('removeDevotional')); ?>',
                data: {
    ...
    $(document).ready(() => {
        ...
        $('#add-day').click((e) => {
            ...
            if (title === "" || reading === "" || verse === "" || content === "\n" || date === "" || author === ""){
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('addDevotional')); ?>',
                    data: {
                        '_token': '<?php echo e(csrf_token()); ?>',
                        'title': title,
                        'reading': reading,
